...
const TermsOfUsePage: FC = () => {
  return (
    <>
      <RootHeader headerTitle='Условия использования' />
...
"Компания", "Мы", "Наш", "Нас", "Нами" или какие-либо другие схожие производные (в зависимости от контекста) означает следующее лицо: ООО "ЭДИСОН", адрес местонахождения: 369387, Карачаево-Черкесская Республика, с. Красный Курган, ул. Набережная, д. 21 (включая, его филиалы и представительства как на территории Российской Федерации, так и за ее пределами, а также какие-либо другие лица, созданные в результате реорганизации Компании), которые являются владельцами Приложения или им управляют.
...
"Приложение" означает следующее приложение: SOUNDKCHR, которое Пользователь загружает через Платформу на смартфон или другое устройство.
...
отправить письмо по следующему адресу: edisoncorp.it@gmail.com
